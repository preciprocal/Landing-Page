  ...
  return (
    <section className="py-24 relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <RevealOnScroll className="text-center mb-14 mt-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <RevealOnScroll>
            <SpotlightCard
              className="rounded-2xl border border-red-500/10 bg-red-500/[0.02] p-6 h-full"
            ...
            >
              ...
              <StaggerChildren className="space-y-3">
                {WITHOUT.map((item, i) => (
                  <StaggerItem key={i}>
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-red-500/[0.03] border border-red-500/[0.06]
                                    hover:bg-red-500/[0.06] transition-colors duration-200">
          ...
          <RevealOnScroll delay={0.1}>
            <SpotlightCard
              className="rounded-2xl border border-emerald-500/10 bg-emerald-500/[0.02] p-6 h-full"
            ...
            >
              ...
              <StaggerChildren className="space-y-3">
                {WITH.map((item, i) => (
                  <StaggerItem key={i}>
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-emerald-500/[0.03] border border-emerald-500/[0.06]
                                    hover:bg-emerald-500/[0.06] transition-colors duration-200">
                      <span className="text-base flex-shrink-0">{item.icon}</span>
