...
const PAIN_POINTS = [
  {
    stat: "73%",
    pain: "of applications get auto-rejected by ATS before a human sees them",
    color: "text-red-400",
    barColor: "bg-red-500",
    barWidth: "73%",
  },
  {
    stat: "6 sec",
    pain: "is all a recruiter spends scanning your resume",
  ...
  {
    stat: "45%",
    pain: "of candidates bomb interviews from nerves, not lack of skill",
  ...
  {
    stat: "200+",
    pain: "applications is the average before landing one offer",
    color: "text-red-400",
    barColor: "bg-red-500",
    barWidth: "85%",
  },
        ...
        <div className="space-y-4">
          {PAIN_POINTS.map((point, i) => (
            <motion.div
              ...
              className="group"
            >
              <div className="flex items-center gap-5 p-5 rounded-2xl bg-white/[0.02] border border-white/[0.05] hover:border-red-500/10 transition-all duration-300">
                {/* Stat */}
