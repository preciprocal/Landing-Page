...
export const BLOG_SEO: Record<string, BlogSeoEntry> = {
  ...
  "software-engineer-interview-prep-guide": {
    title: "SWE Interview Prep: 8-Week Plan (2026)",
  ...
  "system-design-interview-tips": {
    title: "System Design Interview Tips (2026)",
  ...
  "how-to-negotiate-salary-offer": {
    title: "How to Negotiate a Salary Offer (2026)",
  ...
  "amazon-leadership-principles-interview": {
    title: "Amazon Leadership Principles: All 16",
  ...
  "leetcode-study-plan-4-weeks": {
    title: "4-Week LeetCode Study Plan (2026)",
  ...
  "resume-keywords-that-get-past-ats": {
    title: "Resume Keywords That Beat ATS, by Role",
  ...
  "how-to-get-first-tech-job-no-experience": {
    title: "First Tech Job With No Experience",
  ...
  "ats-resume-tips-new-grads": {
    title: "ATS Resume Tips for New Grads (2026)",
  ...
  "how-to-get-job-with-visa-sponsorship-2026": {
    title: "Jobs With Visa Sponsorship in the US",
  ...
  "ai-tools-actually-help-job-search-2026": {
    title: "AI Tools That Help Your Job Search",
  ...
  "networking-for-introverts-get-referrals-2026": {
    title: "Networking When You Hate Networking",
  ...
  "how-to-handle-job-rejection-keep-going": {
    title: "How to Handle Job Rejection (2026)",
  ...
  "linkedin-profile-that-gets-recruiter-messages": {
    title: "LinkedIn Profile Recruiters Message",
  ...
  "what-to-do-first-30-days-new-job": {
    title: "Your First 30 Days at a New Job",
  ...
  "how-to-get-a-job-in-todays-market-2026": {
    title: "How to Get a Job in 2026: Playbook",
  ...
  "ead-card-f1-visa-opt-complete-guide-2026": {
    title: "EAD Card for F1 Students: OPT Guide",
  ...
  "how-to-stop-the-clock-f1-students-opt-2026": {
    title: "OPT Cap-Gap and STEM Strategies (2026)",
  ...
  "h1b-visa-complete-guide-2026": {
    title: "H-1B Visa 2026: Lottery, Fees, Changes",
  ...
  "l1-visa-complete-guide-2026": {
    title: "L-1 Visa Guide 2026: L-1A and L-1B",
  ...
  "o1-visa-extraordinary-ability-guide-2026": {
    title: "O-1 Extraordinary Ability Visa (2026)",
  ...
  "tn-visa-canada-mexico-professionals-2026": {
    title: "TN Visa Guide for Canada and Mexico",
  ...
  "green-card-employment-based-pathways-2026": {
    title: "Employment Green Cards: EB-1 to EB-5",
  ...
  "us-visa-policy-updates-2026": {
    title: "New US Visa Updates 2026: What Changed",
  ...
  "ead-renewal-2026-automatic-extension-ended": {
    title: "EAD Renewal 2026: Auto-Extension Gone",
  ...
  "how-to-check-your-visa-status-2026": {
    title: "Check Your Visa Status: I-94 and SEVIS",
  ...
  "us-job-market-late-2026-data": {
    title: "US Job Market 2026: What Data Says",
