...
export const FAQS: FAQItem[] = [
  ...
  { id: "p2", category: "pricing",      q: "Do you offer a free plan?",                      a: "Yes. The free tier includes 3 resume analyses, 5 cover letters, 1 mock interview, 2 study plans, 2 interview debriefs, 2 LinkedIn optimisations, 3 outreach messages, 3 recruiter contact searches and a 10-job tracker per month. It's a real free plan, not a 7-day trial." },
